...
{
  double ters_R = 1+(param->bigd/0.1)*(0.2+(0.4122449-1))/2;//param->bigr;
  double ters_D = (param->bigd/0.1)*(0.2-(0.4122449-1))/2;//param->bigd;
...
{
  double ters_R = 1+(param->bigd/0.1)*(0.2+(0.4122449-1))/2;//param->bigr;
  double ters_D = (param->bigd/0.1)*(0.2-(0.4122449-1))/2;//param->bigd;s
